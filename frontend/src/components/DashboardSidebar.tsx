        ...
        >
          ...
          >
            ...
            <DashboardSidebarPageItem
              ...
              icon={<BarChartIcon />}
              href="/history"
              selected={!!matchPath('/history/*', pathname) || pathname === '/history'}
            />
            <DashboardSidebarPageItem
              id="ops"
              title="Ops"
              icon={<LayersIcon />}
              href="/ops"
              selected={!!matchPath('/ops/*', pathname) || pathname === '/ops'}
            />
            
            <DashboardSidebarDividerItem />
            <DashboardSidebarHeaderItem>Example Menu</DashboardSidebarHeaderItem>
            <DashboardSidebarPageItem
              id="employees"
              title="Employees"
              icon={<PersonIcon />}
              href="/employees"
              selected={!!matchPath('/employees/*', pathname) || pathname === '/employees'}
            />
            {/* <DashboardSidebarPageItem
              id="reports"
              title="Reports"
